...
<article wire:key="{{$post->id}}"
    class="mt-20 md:mt-0 p-6 md:flex md:items-center bg-white rounded-lg border border-gray-300 shadow-md dark:bg-gray-800 dark:border-gray-700 scale-50 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-200">

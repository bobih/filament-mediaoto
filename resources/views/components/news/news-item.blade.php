...
<article
    ...
    <div class="md:px-4 lg:px-8 w-full">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <x-news.news-badge wire:navigate title="{{$category->slug}}" data-te-ripple-init
                data-te-ripple-color="light" alt="{{$category->slug}}" href="{{ route('news.category', ['category' => $category->slug]) }}"

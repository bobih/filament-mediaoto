        ...
        data-te-carousel-init>
            ...
            <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
               ...
               @foreach ($slider as $slide)
                @if ($first)
                <div style="
                width: 1024px;" class="relative mx-auto  w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                ...
                @else
                <div style="
                width: 1024px;" class="relative mx-auto  hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"

    ...
    <div x-data="{ show: false }" x-show = "show" x-on:open-image-modal.window = "show=true;image=$event.detail.image" x-on:close-image-modal.window = "show=false"
        ...
        <div x-show="show"
             ...
             */ ?>
                ...
                <div wire:ignore id="indicators-carousel" class="relative w-full h-[500px]" data-carousel="static">
                    <!-- Carousel wrapper -->
                    <div class="relative overflow-hidden rounded-lg min-h-full">
                         <!-- Item 1 -->
                        <div class=" duration-700 ease-in-out" data-carousel-item="active">
                            <img src="{{$slider}}" class="absolute mx-auto block h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        </div>
                        <!-- Item 5 -->

...
<div x-data="{ show: false }" x-show = "show" x-on:open-image-modal.window = "show=true;image=$event.detail.image"
    ...
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false"
        ...
        <div class="absolute inset-0 bg-gray-500 dark:bg-gray-900 opacity-85"></div>
    </div>
    ...
    <div x-show="show"
        ...
        data-te-carousel-init>
            ...
            <div style="max-height: 500px" class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
               ...
               @foreach ($slider as $slide)
                ...
                <div  class="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                    ...
                    <img src="{{$slide->image}}" class="block object-cover h-[500px] mx-auto drop-shadow-xl rounded-lg"
                        alt="Wild Landscape" />
            ...
            <button
                class="absolute bottom-0 left-0 top-0 z-[1] flex w-[15%] items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
                type="button" data-te-target="#carouselExampleControls" data-te-slide="prev">
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/60 group-hover:bg-white/50 dark:group-hover:bg-gray-800/80 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            ...
            <button
                class="absolute bottom-0 right-0 top-0 z-[1] flex w-[15%] items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"

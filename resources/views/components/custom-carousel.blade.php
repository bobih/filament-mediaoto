    ...
    <div x-show="show"
        ...
        data-te-carousel-init>
            ...
            <button
                ...
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-600 group-hover:bg-white/50 dark:group-hover:bg-gray-800/80 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">

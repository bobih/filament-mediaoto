...
<!-- Main modal -->
<div
    class="z-50 flex  justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="w-full">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form wire:submit="saveContact">
                ...
                <button wire:loading disabled type="submit" data-sitekey="{{env('RECAPTCHA_SITE_KEY')}}" data-callback='handle'
                    class="g-recaptcha text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">

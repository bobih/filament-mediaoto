<section class=" bg-[#172554] dark:bg-gray-700">
    <div class=" w-full absolute">
        <div
            ...
            <a href="#">
                <div class="flex h-full  bg-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800   items-center rounded-lg dark:bg-gray-700 dark:text-gray-300">
    ...
    <div class="pt-18 gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-3 lg:py-16 lg:px-6">
        ...
        <div class="font-light text-gray-200 sm:text-lg dark:text-gray-400">
            ...
            <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-200 dark:text-white">SOME INFORMATION ABOUT
                OUR COMPANY</h2>
            <div class="pt-16 flex items-center">


                    <svg class="w-10 h-10 fill-current" width="24px" height="24px" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                   ...
                   <svg class="mx-10 w-10 h-10 fill-current" width="24px" height="24px" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="-143 145 512 512" xml:space="preserve">
                    <g>
                    ...
                    <svg class="w-12 h-12 fill-current" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21,2H3A1,1,0,0,0,2,3V21a1,1,0,0,0,1,1H21a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2Zm-3.281,8.725h0c-.109.011-.219.016-.328.017A3.571,3.571,0,0,1,14.4,9.129v5.493a4.061,4.061,0,1,1-4.06-4.06c.085,0,.167.008.251.013v2a2.067,2.067,0,1,0-.251,4.119A2.123,2.123,0,0,0,12.5,14.649l.02-9.331h1.914A3.564,3.564,0,0,0,17.719,8.5Z"/></svg>
        ...
        <div class="mt-10 font-light text-gray-200 sm:text-lg dark:text-gray-400 lg:col-span-2 ">
            ...
            <p  class="mb-4">Kami memiliki visi untuk menjadi pionir agensi penyedia lead dalam jumlah besar di Indonesia, yang dapat
            ...
            <button type="button" class="mt-8 text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2">
                View Detail

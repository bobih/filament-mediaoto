 ...
 class=" bg-[#172554] dark:bg-gray-700">
    ...
    class="pt-18 gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-3 lg:py-16 lg:px-6 intersect:bg-indigo-600 transition-colors">
        ...
        <div class="mt-10 font-light text-gray-200 sm:text-lg dark:text-gray-400 lg:col-span-2 ">
            <p class="mb-4 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-500">{{__('home.aboutus.content1')}}</p>
            <p class="mb-4 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-500">{{__('home.aboutus.content2')}}</p>
            <p class="mb-4 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-500">{{__('home.aboutus.content3')}}</p>

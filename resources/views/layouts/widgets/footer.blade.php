<footer class="p-4 bg-white drop-shadow-2xl sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
                        ...
                        <li>
                            ...
                            <a class="relative inline-flex items-start pt-3 text-sm ">
                                ...
                                <span class="sr-only">Notifications</span>
                                  <div class="absolute inline-flex items-center justify-center w-10 h-5 text-xs  text-gray-600 border border-gray-400 dark:text-gray-400 rounded-full -top-0.5 -end-10">soon</div>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-10 sm:justify-center sm:mt-0">
                <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/mediaoto.id" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/mediaoto.id" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://www.twitter.com/mediaoto" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path

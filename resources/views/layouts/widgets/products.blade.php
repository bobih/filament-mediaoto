    ...
    <section class="bg-gray-100 dark:bg-gray-900 ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0">
                ...
                <!-- Products -->
                <div class="scale-50 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-500">
                    <div class="flex justify-left items-center mb-4 w-75 h-75  lg:h-75 lg:w-75 ">
                        <svg class="h-20 w-20" height="150px" width="150px" viewBox="0 0 150 150"
                            xmlns="http://www.w3.org/2000/svg"
                            style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;fill-rule:evenodd;clip-rule:evenodd">
                ...
                <!-- Products -->
                <div class="scale-50 opacity-0 intersect:scale-100 intersect:opacity-100 transition duration-700 delay-700">
...
<!-- Mobile -->
    <section class="bg-gray-100 dark:bg-gray-900 ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0">
                <!-- Products -->
                <div class="flex scale-50 opacity-0 intersect:scale-100 intersect:opacity-100 intersect-once transition duration-700 delay-500">
                    <div class="mx-4">
                        <svg class="h-20 w-20 " height="150px" width="150px" viewBox="0 0 150 150"
                            xmlns="http://www.w3.org/2000/svg"
                            style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;fill-rule:evenodd;clip-rule:evenodd">

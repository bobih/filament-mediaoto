            ...
            <div>
                <div
                    ...
                    <svg class="h-20 w-20" height="150px" width="150px"  viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path style="opacity:1" fill="#fafbfe" d="M88.5 76.5v40h-46v-40a265.007 265.007 0 0 1 46 0Z" />
                ...
                <div>
                    ...
                    class="flex justify-left items-center mb-4 w-75 h-75  lg:h-75 lg:w-75 ">
                            ...
                            <svg class="h-20 w-20" height="150px" width="150px" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path style="opacity:1" fill="#3a495c"
                                    d="M72.5 41.5h-2c.667-10.667 1.333-10.667 2 0Z" />
                                ...
                                <path style="opacity:1" fill="#39485a"
                                    d="M101.5 70.5c10.667.667 10.667 1.333 0 2v-2Z" />

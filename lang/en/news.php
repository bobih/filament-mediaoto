...
return [
    "banner" => "Automotive and Property News",
    "banner_desc" => "Get the Latest Trends Here",
    "title" => "Your Source for Cutting-Edge News in Cars and Real Estate - Mediaoto",
    ...
    "place_search" => "Search toyota, honda, etc...",
